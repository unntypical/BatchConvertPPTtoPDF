...
2. Place the files "CONVERT_n.bat" and "converter_n.ps1" in this folder. These files should be left in this folder.
...
5. Double click "CONVERT_n.bat" which will run the file, and the powershell script "converter_n.ps1".
